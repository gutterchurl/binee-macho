...
type Hook struct {
	Name        string
	Parameters  []string
	Fn          func(*MacEmulator, *Instruction) bool
	Implemented bool
	Values      []interface{}
	Return      uint64
	HookStatus  string
...
func (emu *MacEmulator) CaptureParameters(n int) []uint64 {
...
func NopHook() *Hook {
	return &Hook{"",
		make([]string, 0, 0),
		func(_ *MacEmulator, _ *Instruction) bool { return true },
		false,
		make([]interface{}, 0, 0),
		0x0,
		"",
...
func (emu *MacEmulator) BuildInstruction(addr uint64, size uint32) *Instruction {
	...
	if name != "" && function != "" {
		if hook != nil {
			...
			if hook.Fn == nil {
				hook.HookStatus = "P"
				instruction.Hook.Fn = func(_ *MacEmulator, _ *Instruction) bool { return true }
...
func SkipFunctionCdecl(set_return bool, ret uint64) func(emu *MacEmulator, instruction *Instruction) bool {
	return func(emu *MacEmulator, instruction *Instruction) bool {
...
func SkipFunctionStdCall(set_return bool, ret uint64) func(emu *MacEmulator, instruction *Instruction) bool {
	return func(emu *MacEmulator, instruction *Instruction) bool {
